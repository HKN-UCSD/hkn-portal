...
class DistributionTests(unittest.TestCase):
    ...
    def test_parse_Description(self):
        ...
        self.assertEqual(
            dist.description, "This package enables integration with " "foo servers."
        )
    ...
    def test_parse_Description_multiline(self):
        ...
        self.assertEqual(
            dist.description, "This package enables integration with\n" "foo servers."
        )
    ...
    def test_parse_Requires_Dist_single_w_env_marker(self):
        ...
        self.assertEqual(
            list(dist.requires_dist), ["SpanishInquisition; python_version == '1.4'"]
        )
    ...
    def test_parse_Project_URL_single_no_version(self):
        ...
        self.assertEqual(
            list(dist.project_urls), ["Bug tracker, http://bugs.example.com/grail"]
        )
