...
var app = (function () {
    ...
    const file$1 = "src/Pages/ProfilePage.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 23, 8, 685);
    			attr_dev(div1, "class", "app svelte-jnfr9r");
    			add_location(div1, file, 21, 4, 639);
    		},
    		m: function mount(target, anchor) {
